...
The `Directory.Build.props` file in your repository will enable usage of Nullable reference types and also make it possible to use extended nullability annotation attributes in projects targeting TFMs before .NET Standard 2.1 (or .NET Core App 3.0).
